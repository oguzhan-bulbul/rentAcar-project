...
public record UpdateIndividualCustomerRequest(
    ...
    @NotNull @NotBlank @Size(min = 3, max = 32) String firstName,
    @NotNull @NotBlank @Size(min = 3, max = 32) String lastName,
    @NotNull @NotBlank @Size(min = 3, max = 32) String nationalIdentity) {}
