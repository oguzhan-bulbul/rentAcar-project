...
public class AdditionalServiceManager implements AdditionalServiceService {
  ...
  public DataResult<List<AdditionalServiceDto>> getAll() {
    ...
    List<AdditionalServiceDto> response =
        result.stream()
            .map(
                additionalService ->
    ...
    return new SuccessDataResult<List<AdditionalServiceDto>>(response, "Services listed.");
  }
  ...
  public DataResult<AdditionalServiceDto> getById(int id) throws BusinessException {
    ...
    AdditionalServiceDto response =
        this.modelMapperService.forDto().map(additionalService, AdditionalServiceDto.class);
  ...
  public Result update(UpdateAdditionalServiceRequest updateAdditionalServiceRequest)
    ...
    checkIfAdditionalServiceDoesNotExistsById(updateAdditionalServiceRequest.additionalServiceId());
  ...
  public Result delete(DeleteAdditionalServiceRequest deleteAdditionalServiceRequest)
    ...
    checkIfAdditionalServiceDoesNotExistsById(deleteAdditionalServiceRequest.additionalServiceId());

    this.additionalServiceDao.deleteById(deleteAdditionalServiceRequest.additionalServiceId());

    return new SuccessResult("Service deleted.");
  }

  public Result checkIfAdditionalServicesDoesNotExistsByIdIsSuccess(
      List<Integer> additionalServiceIds) throws BusinessException {
  ...
  private void checkIfAdditionalServiceExistsByName(
      CreateAdditionalServiceRequest createAdditionalServiceRequest) throws BusinessException {

    if (this.additionalServiceDao.existsByAdditionalServiceName(
        createAdditionalServiceRequest.additionalServiceName().toUpperCase())) {
