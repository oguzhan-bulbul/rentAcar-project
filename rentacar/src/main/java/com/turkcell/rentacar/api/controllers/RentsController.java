...
public class RentsController {
  ...
  public Result add(@RequestBody @Valid CreateRentForIndividualRequest createRentRequest)
  ...
  public Result add(@RequestBody @Valid CreateRentForCorporateRequest createRentRequest)
      throws BusinessException {
  ...
  public Result deleteByRentId(@RequestBody @Valid DeleteRentRequest deleteRentRequest)
      throws BusinessException {
